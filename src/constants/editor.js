...
export var SubMenuType;
(function (SubMenuType) {
  SubMenuType['FONT_FAMILY'] = 'FontFamily';
  SubMenuType['BACKGROUND'] = 'Background';
  SubMenuType['COLOR'] = 'Color';
  SubMenuType['ANIMATIONS'] = 'Animations';
  SubMenuType['EFFECTS'] = 'Effects';
