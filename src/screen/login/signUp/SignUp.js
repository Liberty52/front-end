...
function SignUpInput() {
  return (
    <div className='inputs'>
      ...
      <Input type='password' name='password' label='비밀번호' required={true} maxLength={25} />
      <Input
        type='text'
        name='phoneNumber'
        label='휴대폰번호'
      ...
      />
      <Input type='text' name='name' label='이름' required={true} maxLength={25} />
      <Input type='text' name='recommender' label='추천인' required={false} maxLength={25} />
    </div>
  );
}
